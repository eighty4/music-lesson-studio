...
Future<LessonPlan> getLessonPlan(
  String apiHost,
  UniqueId planId, {
  http.Client? httpClient,
}) async => LessonPlan.fromJson(
  await _getJson('http://$apiHost/api/lessons/$planId', httpClient: httpClient),
);
...
Future<UniqueId> createLessonPlan(
  String apiHost, {
  http.Client? httpClient,
}) async {
  final response = await _send(
    _HttpMethod.post,
    'http://$apiHost/api/lessons',
    httpClient: httpClient,
  );
  if (kDebugMode) {
...
Future<void> updateLessonUnitFrames(
  ...
  await _putJson(
    'http://$apiHost/api/lessons/$planId/units/$unitId/frames',
    frames,
    httpClient: httpClient,
  );
}
...
Future<http.Response> _send(
  ...
  final response = await switch (method) {
    ...
    _HttpMethod.patch => httpClient.post(
      uri,
      headers: additionalHeaders,
      body: body,
    ),
    _HttpMethod.post => httpClient.post(
      uri,
      headers: additionalHeaders,
      body: body,
    ),
    _HttpMethod.put => httpClient.put(
      uri,
      headers: additionalHeaders,
      body: body,
    ),
